        ...
        if current_minute % 2 == 1 and current_second == 0:
            try:
                ...
                for symbol in symbols:
                    ...
                    if latest_ltp:
                        print(f"Latest LTP for {symbol}: {latest_ltp[0]}")
                    else:
...
if __name__ == "__main__":
    ...
    database_path = r'C:\Users\Sohum\Desktop\Synthetic Data for Stocks\tick_data2.db'  # Replace with the path to your SQLite database
