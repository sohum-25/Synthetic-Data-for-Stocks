...
from historic_data import symbol_list
...
def fetch_latest_ltp(symbols, database_path, insert_table, fetch_table):
    while True:
        ...
        if (
            ...
            and (current_time.tm_hour > 9 or (current_time.tm_hour == 9 and current_minute >= 15))
            and (current_time.tm_hour < 15 or (current_time.tm_hour == 15 and current_minute <= 20))
        ):
