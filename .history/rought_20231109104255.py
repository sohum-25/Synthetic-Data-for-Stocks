...
def onmessage(message):
    try:
        ...
        # Create the table if it doesn't exist, and add an index on Datetime
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS tick_data2 (
                Datetime TEXT,
                symbol TEXT,
        ...
        cursor.execute("INSERT OR REPLACE INTO tick_data2 (Datetime, symbol, ltp) VALUES (?, ?, ?)", (Datetime, symbol, ltp))
