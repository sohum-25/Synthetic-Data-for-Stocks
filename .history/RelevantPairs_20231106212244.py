...
def process_stock_data(data_path):
    ...
    return correlation, stock_list, Valid_pairs

# Usage
data_path = 'ind_nifty100list (1).csv'
correlation, stock_list, valid_pairs = process_stock_data(data_path)
...
print(GetRelevantPairs(correlation,0.05,valid_pairs))