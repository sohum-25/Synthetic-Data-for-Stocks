...
if __name__ == "__main__":
    symbol1 = 'Symbol1'  # Replace with the first stock symbol
    symbol2 = 'Symbol2'  # Replace with the second stock symbol
    database_path = 'your_database.db'  # Replace with the path to your SQLite database
