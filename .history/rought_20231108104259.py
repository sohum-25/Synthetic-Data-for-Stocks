   ...
   # Specify the file path
    ...
    and (
        ...
        and (current_hour < 15 or (current_hour == 15 and current_minute <= 20))
            ...
            TotalCapital, inTrade, activeLongPosition, activeShortPosition=CalculateParameters(database_path, symbol_list, 0, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition)
