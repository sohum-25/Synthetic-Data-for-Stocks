...
from datetime import datetime
from TradingFunction import CalculateParameters , MockCalculateParameters,EmptyCalculateParameters
   ...
   # Specify the file path
    ...
    and (
        ...
        and (current_hour < 15 or (current_hour == 15 and current_minute <= 20))
            ...
            TotalCapital,inTrade,activeLongPosition,activeShortPosition= EmptyCalculateParameters(database_path, symbol_list, 1, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition)
            EmptyCalculateParameters(database_path, symbol_list, 0, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition) 
            EmptyCalculateParameters(database_path, symbol_list, 2, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition)
            EmptyCalculateParameters(database_path, symbol_list, 3, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition)
            EmptyCalculateParameters(database_path, symbol_list, 4, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition)
            EmptyCalculateParameters(database_path, symbol_list, 5, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition)
            EmptyCalculateParameters(database_path, symbol_list, 6, TotalCapital, fyers, inTrade, activeLongPosition, activeShortPosition) 
