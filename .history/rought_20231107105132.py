...
if __name__ == '__main__':
    ...
    list_of_symbols =['ADANIENSOL', 'POWERGRID', 'NAUKRI', 'ZOMATO', 'BOSCHLTD', 'EICHERMOT', 'DABUR', 'TATACONSUM', 'TATACONSUM', 'MCDOWELL-N', 'EICHERMOT', 'HEROMOTOCO', 'AMBUJACEM', 'GRASIM', 'ICICIBANK', 'MUTHOOTFIN', 'COALINDIA', 'ONGC', 'GODREJCP', 'TATACONSUM']
