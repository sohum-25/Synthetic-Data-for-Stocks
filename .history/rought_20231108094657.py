   ...
   # Specify the file path
    ...
    and (
        ...
        and (current_hour < 15 or (current_hour == 15 and current_minute <= 20))
            ...
            TotalCapital = 5000
            inTrade = None
            activeLongPosition = None
            activeShortPosition = None

            TotalCapital, inTrade, activeLongPosition, activeShortPosition=CalculateParameters(database_path,symbol_list,0,5000,fyers,inTrade,activeLongPosition,activeShortPosition)
